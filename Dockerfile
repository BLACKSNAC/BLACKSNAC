...
#RUN wget https://raw.githubusercontent.com/BLACKSNAC/BLACKSNAC/master/ustad.py
#RUN wget https://raw.githubusercontent.com/BLACKSNAC/BLACKSNAC/master/requirements.txt
#RUN git clone https://github.com/BLACKSNAC/BLACKSNAC /root/userbot
#RUN mkdir /root/userbot/bin/
#WORKDIR /root/userbot/
#RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
CMD ["python3","ustad.py"]
